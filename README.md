...
Clafer is now available on [Hackage](http://hackage.haskell.org/package/claferIG-0.5.1/) and it can be installed using either [`stack`](https://github.com/commercialhaskell/stack) or [`cabal-install`](https://hackage.haskell.org/package/cabal-install).
...
* [GHC](https://www.haskell.org/downloads) >= 8.4.4 is recommended,
