...
alloyIG.jar: src/manifest src/org/clafer/ig/AlloyIG.java src/edu/mit/csail/sdg/alloy4compiler/parser/AlloyCompiler.java
	...
	javac -cp "alloy4.jar" -d dist/javabuild src/org/clafer/ig/AlloyIG.java src/edu/mit/csail/sdg/alloy4compiler/parser/AlloyCompiler.java
